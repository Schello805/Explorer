...
function HelpBubble({ text }: { text: string }) { return <span className="group relative inline-flex shrink-0 text-[#286551]" title={text}><HelpCircle size={15} aria-hidden="true" /><span className="pointer-events-none absolute left-1/2 top-6 z-30 hidden w-64 -translate-x-1/2 rounded-xl bg-[#173c32] p-3 text-xs font-normal leading-5 text-white shadow-xl group-hover:block">{text}</span></span>; }
